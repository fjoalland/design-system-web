    ...
    static getDictionnary () {
        return ({
            'fr': {
                ...
                'FIELD_VALID_SIZE_ERROR_MESSAGE': 'Merci de télécharger un fichier moins lourd pour : {fieldName}, fichier : {fileName}',
                'FIELD_VALID_FORMAT_ERROR_MESSAGE': 'Merci de télécharger un fichier au bon format pour : {fieldName}, fichier : {fileName}',
            ...
            'en': {
                ...
                'FIELD_VALID_SIZE_ERROR_MESSAGE': 'Please upload a smaller file for: {fieldName}, file : {fileName}',
                'FIELD_VALID_FORMAT_ERROR_MESSAGE': 'Please upload a file with a valid format for: {fieldName}, file : {fileName}',
